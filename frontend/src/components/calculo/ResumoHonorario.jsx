...
/**
 * Define cor mais clara para placeholders e cor padrão para valores preenchidos.
 */
      ...
      <div className="border border-slate-200 bg-white p-6">
        ...
        <ul className="space-y-3 text-sm">
          <li className="flex justify-between gap-4">
            ...
            <span className={`text-right font-medium ${getClass(regimeTexto)}`}>{regimeTexto}</span>
          </li>
          <li className="flex justify-between gap-4">
          ...
          <li className="flex justify-between gap-4">
            ...
            <span className={`text-right font-medium ${getClass(faturamentoTexto)}`}>{faturamentoTexto}</span>
          </li>
          <li className="flex justify-between gap-4">
          ...
          <li className="flex justify-between gap-4">
            ...
            <span className={`text-right font-medium ${getClass(funcionariosTexto)}`}>{funcionariosTexto}</span>
          </li>
          <li className="flex justify-between gap-4">
            <span className="text-slate-500">Filiais:</span>
            <span className={`text-right font-medium ${getClass(filiaisTexto)}`}>{filiaisTexto}</span>
          </li>
          <li className="flex justify-between gap-4">
